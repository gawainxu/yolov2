# -*- coding: utf-8 -*-
"""
Created on Fri Feb  8 17:48:11 2019
...
def reorg(input_tensor, stride):
    ...
    channel_first = Permute((3, 2, 1))(input_tensor)
...
def conv_batch_lrelu(input_tensor, numfilter, dim, strides = 1):
    ...
    input_tensor = Conv2D(numfilter, (dim, dim), strides = strides, padding = 'same', kernel_regularizer=regularizers.l2(0.0005),
...
def NetworkInNetwork(input_tensor, dims):
    ...
    for d in dims:
        input_tensor = conv_batch_relu(input_tensor, *d)
